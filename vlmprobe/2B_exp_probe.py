...
model = Qwen2VLForConditionalGeneration.from_pretrained(
    "Qwen/Qwen2-VL-2B-Instruct", torch_dtype = "float16", device_map = "cuda"
...
processor = AutoProcessor.from_pretrained("Qwen/Qwen2-VL-2B-Instruct") # we created a processor object based on the downloaded model's processor configuration files

...
Model: Qwen3-VL-8B-Instruct. d_model and the layer count are read from the
config rather than assumed, so nothing here is tied to the 2B/7B geometry. The
...
# ---------------------------------------------------------------------------
# Step 1: load PaliGemma2-3B (pt-224)
# ---------------------------------------------------------------------------
